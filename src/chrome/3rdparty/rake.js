...
async function buildStopWordRegex (words) {
...
async function loadStopWords (path) {
...
async function rake(text, stopWords, minCharLength=3, maxWordsLength=5, minKeywordFrequency=1) {
  let stopWordPattern = await buildStopWordRegex(stopWords)
