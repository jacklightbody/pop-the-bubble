...
var Lemmatizer = function() {
  this.wn_files = {
    noun: [
      '3rdparty/dict/index.noun.json',
      '3rdparty/dict/noun.exc.json'
    ],
    verb: [
      '3rdparty/dict/index.verb.json',
      '3rdparty/dict/verb.exc.json'
    ],
    adj:  [
      '3rdparty/dict/index.adj.json',
      '3rdparty/dict/adj.exc.json'
    ],
    adv:  [
      '3rdparty/dict/index.adv.json',
      '3rdparty/dict/adv.exc.json'
    ]
  };
